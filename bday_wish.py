...
def page_voice():
    ...
    # FIX: Check if the voice file exists before trying to render st.audio AND
    # Add a key for reliable JS targeting.
    if voice_path:
            ...
            if (bgMusic && voiceAudio) {
                ...
                const resumeMusic = function() {
                    ...
                    if (voiceAudio.paused || voiceAudio.ended) { 
                        bgMusic.volume = 0.4; // Restore volume if it was changed
